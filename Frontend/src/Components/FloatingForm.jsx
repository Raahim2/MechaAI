...
const FloatingForm = ({ selectedcol, filepath, task , setfilepath , setvisible }) => {
  let form1 = `
        <div id='Fill NA' className="fixed top-0 right-0 z-50 bg-gray-800 text-gray-200 p-2 rounded-md w-96">
      <div className="flex items-center space-x-2">
        ...
        <button className="bg-gray-700 p-2 rounded-md" onClick={sendForm}>
  ...
  `
  let form2= `
      <div id='Replace' className="fixed top-0 right-0 z-50 bg-gray-800 text-gray-200 p-2 rounded-md w-96">
      <div className="flex items-center space-x-2">
        <div className="flex-1">
          <input
            id='input1'
  ...
  function sendForm() {
    ...
    formData.append('input1', inputValue1);
    // formData.append('input2', inputValue2);
  ...
  return (
    ...
    <div id='Replace' className="hidden fixed top-0 right-0 z-50 bg-gray-800 text-gray-200 p-2 rounded-md w-96">
      <div className="flex items-center space-x-2">
        <div className="flex-1">
          <input
            id='input1'
