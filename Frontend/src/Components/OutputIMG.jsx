...
function OutputIMG({ imgpath  , setimgpath  , setInitialImagePath ,uploaded , setUploaded , selected , setSelected}) {
...
function uploadFile(event) {
  ...
  return (
    ...
    <div className={`bg  border-b border-gray-700 flex justify-center items-center relative ${
        selected === "adjust" ? "h-[80vh]" : "h-[85vh]"
      }`} id="maindiv">
      <div>
      {selected === "cropping" ? (
          <CropperComponent
          setimagepath={setimgpath}
          imageSrc={imgpath}
