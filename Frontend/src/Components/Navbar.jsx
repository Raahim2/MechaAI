...
function Navbar({username , download}) {

  return (
    <>
    <nav className="fixed top-0 z-50 w-full border-b border-gray-200 bg border-gray-700">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-start rtl:justify-end">
          ...
          <a href="" className="flex ms-2 md:me-24">
            ...
            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-white">Image AI</span>
          </a>
        </div>
