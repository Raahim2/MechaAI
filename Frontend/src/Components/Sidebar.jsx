...
function SideBar({username}) {
  ...
  return (
    <>
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg border-r border-gray-200 sm:translate-x-0 " aria-label="Sidebar">
