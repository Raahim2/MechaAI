...
function Editor({username }) {
  ...
  return (
    ...
    <LowerNav FUNCTIONS={FUNCTIONS} setimagepath={setimgpath} initialpath={initialpath}/>
    <OutputIMG imgpath={imagepath} setimgpath={setimgpath} setInitialImagePath={setInitialpath} uploaded={uploaded} setUploaded={setUploaded}/>
